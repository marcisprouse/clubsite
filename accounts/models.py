...
class MyProfile(UserenaBaseProfile):
    ...
    member_coyote_lakes_qualifying_address = models.ForeignKey(Certificate, on_delete=models.CASCADE, related_name='member_coyote_lakes_qualifying_address', blank=True, null=True, help_text='Choose address from dropdown, if applies to this profile.')
