...
def export_logins_xls(request):
    ...
    columns = ['Last Login Date', 'Certificate Number', 'Last name', 'First name', 'Email address', 'Cell Phone', 'Street Number', 'Street', 'Temporary Password', 'Member ID', 'Is Active Member']
