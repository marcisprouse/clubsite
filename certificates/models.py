...
class Certificate(models.Model):
    ...
    name_associated_with_certificate = models.ForeignKey("accounts.MyProfile", on_delete=models.CASCADE, related_name='name_associated_with_certificate', blank=True, null=True, help_text="Choose one only. If you need to identify another person, put it in the notes. If the main name/owner associated is not in the dropbox, you have to add the user account. See instructions.")
