...
class CertificateAdmin(AddressAutocompleteAdminMedia, admin.ModelAdmin):
    list_per_page = 1000
    ...
    search_fields = ["certificate_number", "member_coyote_lakes_address__route","member_coyote_lakes_address__street_number", "name_associated_with_certificate", "certificate_notes"]
